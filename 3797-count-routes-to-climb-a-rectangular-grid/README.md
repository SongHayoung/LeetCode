<h2><a href="https://leetcode.com/problems/count-routes-to-climb-a-rectangular-grid">4153. Count Routes to Climb a Rectangular Grid</a></h2><h3>Hard</h3><hr><p>You are given a string array <code>grid</code> of size <code>n</code>, where each string <code>grid[i]</code> has length <code>m</code>. The character <code>grid[i][j]</code> is one of the following symbols:</p>
