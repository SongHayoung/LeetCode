<h2><a href="https://leetcode.com/problems/height-of-special-binary-tree/">2773. Height of Special Binary Tree</a></h2><h3>Medium</h3><hr><div><p>You are given a <code>root</code>, which is the root of a <strong>special</strong> binary tree with <code>n</code> nodes. The nodes of the special binary tree are numbered from <code>1</code> to <code>n</code>. Suppose the tree has <code>k</code> leaves in the following order: <code>b<sub>1 </sub>&lt;<sub> </sub>b<sub>2 </sub>&lt; ... &lt; b<sub>k</sub></code>.</p>
...
<pre><strong>Input:</strong> root = [1,2,3,null,null,4,null,5,6]
