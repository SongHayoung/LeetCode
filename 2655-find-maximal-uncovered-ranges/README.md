...
<pre><strong>Input:</strong> n = 10, ranges = [[3,5],[7,8]]
...
<pre><strong>Input:</strong> n = 3, ranges = [[0,2]]
...
<pre><strong>Input:</strong> n = 7, ranges = [[2,4],[0,3]]
