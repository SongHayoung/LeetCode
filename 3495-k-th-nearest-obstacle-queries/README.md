<h2><a href="https://leetcode.com/problems/check-if-two-chessboard-squares-have-the-same-color">3495. K-th Nearest Obstacle Queries</a></h2><h3>Medium</h3><hr><p>There is an infinite 2D plane.</p>
