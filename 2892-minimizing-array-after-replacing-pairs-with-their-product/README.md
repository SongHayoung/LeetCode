<h2><a href="https://leetcode.com/problems/minimizing-array-after-replacing-pairs-with-their-product/">2892. Minimizing Array After Replacing Pairs With Their Product</a></h2><h3>Medium</h3><hr><div><p>Given an integer array <code>nums</code> and an integer <code>k</code>, you can perform the following operation on the array any number of times:</p>
...
<pre><strong>Input:</strong> nums = [2,3,3,7,3,5], k = 20
...
<pre><strong>Input:</strong> nums = [3,3,3,3], k = 6
