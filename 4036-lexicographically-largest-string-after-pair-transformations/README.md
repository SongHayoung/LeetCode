<h2><a href="https://leetcode.com/problems/lexicographically-largest-string-after-pair-transformations">4366. Lexicographically Largest String After Pair Transformations</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code>.</p>
