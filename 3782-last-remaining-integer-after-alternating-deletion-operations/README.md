<h2><a href="https://leetcode.com/problems/last-remaining-integer-after-alternating-deletion-operations">4164. Last Remaining Integer After Alternating Deletion Operations</a></h2><h3>Hard</h3><hr><p>You are given an integer <code>n</code>.</p>
