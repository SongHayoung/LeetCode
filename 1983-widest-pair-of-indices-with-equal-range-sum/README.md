...
<pre><strong>Input:</strong> nums1 = [1,1,0,1], nums2 = [0,1,1,0]
...
<pre><strong>Input:</strong> nums1 = [0,1], nums2 = [1,1]
...
<pre><strong>Input:</strong> nums1 = [0], nums2 = [1]
