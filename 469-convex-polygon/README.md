<h2><a href="https://leetcode.com/problems/convex-polygon/">469. Convex Polygon</a></h2><h3>Medium</h3><hr><div><p>You are given an array of points on the <strong>X-Y</strong> plane <code>points</code> where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>. The points form a polygon when joined sequentially.</p>
