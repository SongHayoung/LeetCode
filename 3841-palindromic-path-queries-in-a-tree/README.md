<h2><a href="https://leetcode.com/problems/palindromic-path-queries-in-a-tree">4209. Palindromic Path Queries in a Tree</a></h2><h3>Hard</h3><hr><p>You are given an undirected tree with <code>n</code> nodes labeled 0 to <code>n - 1</code>. This is represented by a 2D array <code>edges</code> of length <code>n - 1</code>, where <code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>]</code> indicates an undirected edge between nodes <code>u<sub>i</sub></code> and <code>v<sub>i</sub></code>.</p>
