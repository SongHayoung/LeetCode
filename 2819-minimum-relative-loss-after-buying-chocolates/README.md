...
<pre><strong>Input:</strong> prices = [1,9,22,10,19], queries = [[18,4],[5,2]]
...
<pre><strong>Input:</strong> prices = [1,5,4,3,7,11,9], queries = [[5,4],[5,7],[7,3],[4,5]]
...
<pre><strong>Input:</strong> prices = [5,6,7], queries = [[10,1],[5,3],[3,3]]
