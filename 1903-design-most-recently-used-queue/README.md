<h2><a href="https://leetcode.com/problems/design-most-recently-used-queue">1903. Design Most Recently Used Queue</a></h2><h3>Medium</h3><hr><p>Design a queue-like data structure that moves the most recently used element to the end of the queue.</p>
