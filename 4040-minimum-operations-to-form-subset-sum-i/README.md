<h2><a href="https://leetcode.com/problems/minimum-operations-to-form-subset-sum-i">4379. Minimum Operations to Form Subset Sum I</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>sum</code>.</p>
