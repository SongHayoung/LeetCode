<h2><a href="https://leetcode.com/problems/number-of-ways-to-paint-sheets">4132. Number of Ways to Paint Sheets</a></h2><h3>Hard</h3><hr><p>You are given an integer <code>n</code> representing the number of sheets.</p>
