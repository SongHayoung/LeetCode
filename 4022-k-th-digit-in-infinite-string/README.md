<h2><a href="https://leetcode.com/problems/k-th-digit-in-infinite-string">4331. K-th Digit in Infinite String</a></h2><h3>Medium</h3><hr><p>You are given an integer <code>k</code>.</p>
