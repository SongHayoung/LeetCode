<h2><a href="https://leetcode.com/problems/count-valid-sequences">4345. Count Valid Sequences</a></h2><h3>Medium</h3><hr><p>You are given two <strong>positive</strong> integers <code>n</code> and <code>k</code>.</p>
